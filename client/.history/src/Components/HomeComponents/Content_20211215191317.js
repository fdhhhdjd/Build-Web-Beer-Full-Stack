      ...
      <ContentHome>
        <section className="home" id="home">
          <div className="content">
            ...
            <p>
              244 / 5.000 Kết quả dịch we always bring to everyone all the best
              selling beers and many places in the world, there are many types
              of high to low from high to low strength depending on each person,
              we always bring you !
            </p>
            <Buttons
              css="btn"
